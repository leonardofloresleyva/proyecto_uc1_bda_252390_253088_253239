...
CREATE TABLE IF NOT EXISTS AUDITORIA_CITAS(
    ...
    ESTADO_ANTERIOR ENUM("Atendida", "Cancelada", "No asistió paciente", "No atendida") NOT NULL,
    ESTADO_NUEVO ENUM("Atendida", "Cancelada", "No asistió paciente", "No atendida") NOT NULL,
    ID_CITA INT NOT NULL,
    FOREIGN KEY (ID_CITA) REFERENCES CITAS(ID_CITA)
);
